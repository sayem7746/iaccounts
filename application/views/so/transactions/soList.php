		...
		<div class="row-fluid">
			<div class="span12">
            	<div class="block">
                	<div class="head">
                    	...
                    	<ul class="buttons">
                    		<li><a href="<?php echo base_url()?>sotransaction/salesOrder" title="Add New"><span class="i-plus-2"></span></a></li>
                        </ul>                                        
                    </div><!-- head -->
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
            			...
            			<th class="tac">#</th>
                        <th><?php echo $this->lang->line('orderNo') ?></th>
                        <th class="tac"><?php echo $this->lang->line('orderDate') ?></th>
                        <th><?php echo $this->lang->line('memo') ?></th>
			...
			<?php $bil = 0; 
            	...
            	<tr>
                	...
                	<td class="tac"><?php echo $datatbl->salesOrderDate?></td>
                	<td><?php echo $datatbl->memo?></td>
                	<td class="tar"><?php echo number_format($datatbl->totalAmount,2); ?></td>
