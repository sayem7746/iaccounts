	...
	<div class="info">
		<h1><?php echo $module ?></h1>
			<ul class="breadcrumb">
                ...
                <li><a href='<?php echo base_url()."purchasing/home" ?>'> <?php echo $module ?></a> <span class="divider">-</span></li>
        	...
        	<div class="block">
            	<div class="head">
                	<h2><?php echo $title ?></h2>
                    	<ul class="buttons">
                        	<li><a href="#" onClick="location.reload()" class="block_loading" title="Refresh"><span class="i-cycle"></span></a></li>
                            <li><a href="#" class="block_toggle" title="Close"><span class="i-arrow-down-3"></span></a></li>
                            <li><a href="../icsetting/umconversion" ><span class="i-plus-2"></span></a></li>
                        </ul>                                        
                </div>
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
            			...
            			<th width="20">#</th>
            			<th>From Unit Measure</th>
            			<th>To Unit Measure</th>
            			<th>Unit</th>
                		<th>Factor</th>
