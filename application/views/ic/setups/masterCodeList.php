...
$(document).ready(function() {
    ...
    $("#row_edit").dialog({
        ...
        buttons: {
            "Continue...": function() {
//				window.location.href = "itemEdit?ID=" + ID;		
				window.location.href = "../setting/masterCodeSetup?id=" + ID;
                $(this).dialog("close");
            },
            Cancel: function() {
                $(this).dialog("close");
		...
		<div class="span12">
        	<div class="block">
            	<div class="head">
                	<h2><?php echo $this->lang->line('titlelist') ?></h2>
                    	<ul class="buttons">
                    	<ul class="buttons">
                        	<li><a href="itemNew" class="" title="New"><span class="i-plus-2"></span></a></li>
                        </ul>                                        
                </div>
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('SequenceNumber') ?></th>                
			...
			<?php $bil = 0; 
            	...
            	<tr>
                	...
                	<td title="<?php echo $datatbl->name; ?>"><?php echo $datatbl->name; ?></td>
                	<td><?php echo $datatbl->shortName; ?></td>
                	<td><?php echo $datatbl->description; ?></td>
                	<td align="center"><?php echo $datatbl->orderNo; ?></td>
                  <td><?php 
