		...
		<div class="span12">
        	<div class="block">
            	<div class="head">
                	<h2><?php echo $this->lang->line('titlelist') ?></h2>
                    	<ul class="buttons">
                    		<li><a href="<?php echo base_url()?>tax/setup" title="Add New"><span class="i-plus-2"></span></a></li>
                        </ul>                                        
                </div>
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
            			...
            			<th><?php echo $this->lang->line('taxType') ?></th>
            			<th class="tac"><?php echo $this->lang->line('taxPercentage') ?></th>
            			<th><?php echo $this->lang->line('taxClass') ?></th>
            			<th><?php echo $this->lang->line('taxGroup') ?></th>
            			<th><?php echo $this->lang->line('description') ?></th>
            			<th><?php echo $this->lang->line('taxAccount') ?></th>
			...
			<?php $bil = 0; 
            	...
            	<tr>
                	...
                	<td id="name"><?php echo $datatbl->name; ?></td>
                	<td id="taxType"><?php echo $datatbl->desctype; ?></td>
                	<td id="taxPercentage" class="tar"><?php echo $datatbl->taxPercentage; ?>%</td>
                	<td id="taxClass"><?php echo $datatbl->descclass; ?></td>
                	<td id="taxGroup"><?php echo $datatbl->descgroup; ?></td>
                	<td id="description"><?php echo $datatbl->description; ?></td>
                	<td id="taxAccount"><?php echo $datatbl->acctcode; ?> [<?php echo $datatbl->acctname; ?>]</td>
                	<td id="status" class="tac"><?php if($datatbl->status == 0){ echo $this->lang->line('active');}else{ echo $this->lang->line('inactive');} ?></td>
                    <td class="tac"><?php
