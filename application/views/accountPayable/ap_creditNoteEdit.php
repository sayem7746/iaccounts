<style type="text/css">
#listDetails input:focus { width:150px; }
#listCharge input:focus { width:150px; }
...
<script>
              ...
              function editRow(me){
				//  alert( $(me).parent().parent().find("td").eq(0).html()); 
				   $(''+
					 '<tr>' +
					 	'<td classs="span1"><input classs="span12" id="itemcode" name="itemcode" onkeyup="getItemDetails(this);" onchange="getItemDetails(this);" data-source="<?php echo $itemCodes; ?>" data-items="4" data-provide="typeahead"  class="input-mini" type="text" value="' + $(me).parent().parent().find("td").eq(0).html() + '"></td>' +
						'<td classs="span2"><input id="itemname" name="itemname" class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(1).html() + '"></td>'+
                        '<td classs="span2"><input id="itemdes" name="itemdes" class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(2).html() + '"></td>'+
                        '<td classs="span1"><input id="itemunitprice" onchange="calculamount()" name="itemunitprice" class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(3).html() + '"></td>'+
                        '<td classs="span1"><input id="itemqte" onchange="calculamount()" name="itemqte"  class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(4).html() + '"></td>'+
                        '<td classs="span1"><input id="itemAmountET" name="itemAmountET" class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(5).html() + '"></td>'+
                        '<td classs="span1"><div  class="input-prepend span12"><input  value="' + $(me).attr("data-taxrate") + '" data-taxid="' + $(me).attr("data-taxid") + '" id="itemTax" onkeyup="calculamount()" onblur="calculamount()" name="itemTax" class="input-mini validate[required, custom[number]]" type="text" placeholder="Tax(%)"><span onclick="taxPopup ()" id="displayTaxCode" style="margin:0; padding:0; height :18px;" class="add-on">' + $(me).attr("data-taxcode") +'</span></div></td>'+
                        '<td classs="span1"><input id="itemTaxAmount" name="itemTaxAmount" class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(7).html() + '"></td>'+
                        '<td classs="span1"><input id="itemAmountIT" name="itemAmountIT" class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(8).html() + '"></td>'+
                        '<td classs="span1">'+
		 ...
		 function updateRow(me){
			// alert($(me).attr("data-myid"));
		 	$.ajax({
				...
				url: "<?php echo base_url() ?>purchaseCreditNote/updateRowDetail",
				success: function(data) {
			...
			function msg(n,type, message){
			  ...
			  function deleteCompanyDetails(me){
				...
				url: "<?php echo base_url() ?>purchaseCreditNote/deleteCompanyDetails",
					success: function(data) {
