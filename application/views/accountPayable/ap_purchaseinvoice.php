...
//});
				...
				function getItemCode(me){
					$.ajax({
						...
						url: "<?php echo base_url() ?>purchaseInvoice/getItemCodes",
						success: function(data) {
				...
				function refreshTerms(){
					$.ajax({
						type: "POST",
						url: "<?php echo base_url() ?>purchaseInvoice/refreshTerms",
						success: function(data) {
				...
				function getTermDescription(me){
					$.ajax({
						type: "POST",
						data: "term="+ me.value,
						url: "<?php echo base_url() ?>purchaseInvoice/getTermDescription",
						success: function(data) {
				 ...
				 if( $("#parchaseDetailForm").validationEngine('validate')){
					if ( $("#purchaseInvoiceId").val()=="null"){
						...
						data: {
						 ...
						 url: "<?php echo base_url() ?>purchaseInvoice/saveParchaseRow",
						 success: function(data) {
					 	 var resul = eval ("(" + data + ")"); 
						...
						url: "<?php echo base_url() ?>purchaseInvoice/saveParchaseDetail",
						success: function(data) {
						 msg (1,"alert alert-success","Details successfully saved");
					 	  var resul = eval ("(" + data + ")"); 
					   $(''+
...
function checkformNumber(me){
	...
	$.ajax({
	  type: "POST",
	  data: "code="+ me.value,
	  url: "<?php echo base_url() ?>purchaseInvoice/checkformNumber",
	  success: function(data) {
		  answer = data;
		  if(data=="yes"){
...
function saveCharge(){
	...
	if ( $("#purchaseInvoiceId").val()=="null"){
		  ...
		  url: "<?php echo base_url() ?>purchaseInvoice/saveCharge",
		  success: function(data) {
			var resul = eval ("(" + data + ")"); 
			$("#purchaseInvoiceId").val(resul.invoiceID);
			$(''+
		  ...
		  url: "<?php echo base_url() ?>purchaseInvoice/saveChargeDetailOnly",
		  success: function(data) {
			var resul = eval ("(" + data + ")"); 
			$(''+
		   '<tr>' +
...
function refreshLocation(){
 $.ajax({
	type: "POST",
	url: "<?php echo base_url() ?>purchaseInvoice/refreshLocation",
	success: function(data) {
	  ...
	  <div class="span12 scCol">
		<div class="block" id="grid_block_4">
          <div class="content np">
                      ...
                      <div class="span3"><?php echo $this->lang->line('taxAmount')?></div>
                      <div class="span8">
