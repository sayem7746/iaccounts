				...
				//  alert( $(me).parent().parent().find("td").eq(0).html()); 
				   $(''+
					 '<tr>' +
                        ...
                        '<td class="span1"><input id="itemunitprice" onchange="calculamount()" name="itemunitprice" class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(3).html() + '"></td>'+
                        '<td class="span1"><input id="itemqte" onchange="calculamount()" name="itemqte"  class="span12" type="text" value="' + $(me).parent().parent().find("td").eq(4).html() + '"></td>'+
		 ...
		 function updateRow(me){
			// alert($(me).attr("data-myid"));
		 	$.ajax({
				...
				url: "<?php echo base_url() ?>purchaseDebitNote/updateRowDetailDebitNote",
				success: function(data) {
