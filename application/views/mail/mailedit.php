				...
				<div class="content np"> <!-- Content 1 -->   
                  <div class="controls-row"> <!-- row 1 -->
                    	<div class="span2"><?php echo form_label('Mail Referrence No. :','ref_no');?></div>
                   		<div class="span10">
								...
								echo form_input($data, $mailmaster->ref_no); ?>
                  		</div>
                  </div><!-- End Row 1 -->
                  <div class="controls-row"> <!-- row 1 -->
                    	<div class="span2"><?php echo form_label('Mail From :','mailt_from');?></div>
                   		<div class="span10">
								...
								echo form_input($data, $mailmaster->mailt_from); ?>
                  		</div>
                  </div><!-- End Row 1 -->
                  <div class="controls-row"> <!-- row 1 -->
                    	<div class="span2"><?php echo form_label('Mail To :','mailt_to');?></div>
                   		<div class="span10">
								...
								$data = array(
									...
									'id'=>'mailt_to', 
									'class'=>'span9 validate[required],maxSize[50]',); 
								echo form_input($data, $mailmaster->mailt_to); ?>
                  		</div>
                  </div><!-- End Row 1 -->
                    ...
                    <div class="span9">
                    	<div class="input-prepend">
                        	<span class="add-on"><i class="i-calendar"></i></span>
								...
								echo form_input($data, date("d-m-Y", strtotime($mailmaster->mailt_dt))); ?>
                        </div>
                    </div>
                    </div><!-- End Row 3 -->
                  <div class="controls-row"> <!-- row 1 -->
                    	<div class="span2"><?php echo form_label('Title :','title');?></div>
                   		<div class="span10">
								...
								$data = array(
									...
									'id'=>'title', 
									'class'=>'span9 validate[required],maxSize[100]',); 
								echo form_input($data, $mailmaster->title); ?>
                  		</div>
                  </div><!-- End Row 1 -->
                  	...
                  	<div class="span2"><?php echo form_label('Description:','desc');?></div>
                   	<div class="span10">
						<?php
							...
							echo form_textarea($data, $mailmaster->desc); ?>                       
                    </div>                        
                  </div><!-- End Row 2 -->
                    	...
                    	<div class="input-prepend">
                        	<span class="add-on"><i class="i-calendar"></i></span>
								...
								$data = array(
									...
									'id'=>'mailt_rvcdate', 
									'class'=>'datepicker',); 
								echo form_input($data, date("d-m-Y", strtotime($mailmaster->mailt_rvcdate))); ?>
                        </div>
                     </div>
                 	</div><!-- End Row 4-->
                  <div class="controls-row"> <!-- row 1 -->
                   	...
                   	<div class="span4">
						<?php
							$preseldept = $mailmaster->mailt_rcv_by;
                  ...
                  <div class="controls-row"> <!-- row 1 -->
                   	...
                   	<div class="span4">
						<?php
							$options='';
							$preseldept = $mailmaster->mailt_type;
							$options[] = '--Please Select--';
