		...
		<div class="span12">
        	<div class="block">
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
            			...
            			<th><?php echo $this->lang->line('accountCode') ?></th>
			...
			<?php $bil = 0; 
            	...
            	<tr>
                	...
                	<td><?php echo $bil; ?></td>
                <td><a title="Edit" class="btn btn-mini btn-link edit"><?php echo $datatbl->customerName; ?></a></td>
           
                    <td><?php echo $datatbl->accountCode; ?></td>
