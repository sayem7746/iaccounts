...
function changeList(){
	...
	var urls = "<?php echo base_url();?>glreports/postedjournal/"+addyear+"/"+addper;
		...
		<div class="row-fluid">
			...
			<?php $bil = 0; 
            	...
            	<tr>
                    ...
                    <td><a title="<?php echo $this->lang->line('details');?>" class="btn btn-mini btn-link edit"><?php echo $datatbl->journalID ?></a></td>
