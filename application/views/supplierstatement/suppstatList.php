...
$(document).ready(function() {
    ...
    $("#row_edit").dialog({
        ...
        buttons: {
            "Continue...": function() {
				window.location.href = "CustomerNew?ID=" + ID;		
                $(this).dialog("close");
            },
            Cancel: function() {
                $(this).dialog("close");
		...
		<div class="span12">
        	<div class="block">
            	<div class="head">
                	<h2><?php echo $this->lang->line('titlelist') ?></h2>
                    	<ul class="buttons">
                    	<ul class="buttons">
                        	<li><a href="CustomerNew" class="" title="New"><span class="i-plus-2"></span></a></li>
                        </ul>                                        
                </div>
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
            			...
            			<th><?php echo $this->lang->line('suppliercode') ?></th>
                        <th><?php echo $this->lang->line('referenceNo') ?></th>
			...
			<?php $bil = 0; 
            	...
            	<tr>
                	...
                	<td><?php echo $bil; ?></td>
                <td><a title="Edit" class="btn btn-mini btn-link edit"><?php echo $datatbl->supplierName; ?></a></td>
           
                    <td><?php echo $datatbl->suppliercode; ?></td>
                    <td><?php echo $datatbl->referenceNo; ?></td>
                    <td><?php echo $datatbl->description; ?></td>
                    <td><?php echo $datatbl->balance; ?></td>
                    <td><?php echo $datatbl->debit; ?></td>
                    <td><?php echo $datatbl->credit; ?></td>
