...
$(document).ready(function() {
    ...
    $("#row_edit").dialog({
        ...
        buttons: {
            "Continue...": function() {
				window.location.href = "<?php echo base_url() ?>supplierPayment/edit/" + ID;		
                $(this).dialog("close");
            },
            Cancel: function() {
                $(this).dialog("close");
...
function changeList(){
	...
	var urls = "<?php echo base_url();?>SupplierPayment/supplierpaymentlist/<?php echo $mode;?>/"+selDateFrom+"/"+selDateTo;
		window.location = urls;
}

function printSupplierPaymentList(){
	var selDateFrom = $('#selDateFrom').val();
	var selDateTo = $('#selDateTo').val();
	window.open("<?php echo base_url();?>SupplierPayment/supplierpaymentlist_print/<?php echo $mode;?>/"+selDateFrom+"/"+selDateTo);
        ...
        if($(this).is(':checked')){
			...
			var postData = {
 			...
 			$.ajax({
  				type: "POST",
	  			dataType: "json",
				url: "<?php echo base_url()?>supplierpayment/supplierPaymentList<?php echo $mode;?>/",
				data: postData ,
	  			async: false,
	...
	<div class="row-fluid">
		<div class="span12">
        	<div class="block">
            	...
            	<div class="head">
                	<h2><?php echo $this->lang->line('titleadvicelist');?></h2>
                    	<ul class="buttons">
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
                		...
                		<?php
							if (!isset($mode)) $mode='rpt'; //case terlupa nak assign, defaul to mode rpt
							switch ($mode) {
								case "edit" : 
									echo"<th width='55' class='tac'>"; 
            	...
            	<tr>
                    ...
                    <td><?php echo $datatbl->amountPaid ?></td>
						...
						if ($mode == "edit"){
							...
							$js = 'class="btn btn-mini btn-primary edit" title="'.$this->lang->line("edit").'"';
							echo form_button('edit','<span class="i-printer">',$js);
						}
							?></td>
                </tr>
            <?php endforeach; }?>
            	...
            	<div class='side fr'>
                	<div class='btn-group'>";
							$data = array(
									'name'=>'updatePosting', 
									'class'=>'btn btn-warning');
							$js='onclick="printSupplierPaymentList()"';
