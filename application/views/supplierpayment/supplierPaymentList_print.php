...
<title>Supplier Payment List From <?php echo date('d-m-Y',strtotime($dateFrom)).' To '.date('d-m-Y',strtotime($dateTo)) ?></title>
...
function do_printexcel(){
	var url = "<?php echo base_url()?>SupplierPayment/supplierPaymentList_excel/<?php echo $mode?>/<?php echo $dateFrom?>/<?php echo $dateTo?>";
