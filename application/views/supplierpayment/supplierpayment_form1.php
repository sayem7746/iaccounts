	...
	<div class="row-fluid">
		<div class="span12">
			<?php 
            	...
            	<div class="block">
                	<div class="head">
                    	<h2><?php echo form_label($this->lang->line('supplierPaymentForm'),'supplierPaymentForm');?></h2>
                        <div class="side fr">
...
?>
     ...
     </td><td><div class="block">       <div class="controls-row">
                 ...
                 <div class="controls-row">
                       <div class="span3"><?php echo form_label($this->lang->line('paymentDate'),'paymentDate');?></div>
                       <div class="span6">
            	...
            	<table name="listInvoice" id="listInvoice" cellpadding="0" cellspacing="0" width="100%" id="test" class="editable" border="0">
                	<thead>
                    <tr>
              			<th style="display:none"></th><th></th>
...
<div>
<table width="100%"class="editable" border="0">
<tr><td>                     
<div class="controls-row">
