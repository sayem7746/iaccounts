...
$(document).ready(function() {
    ...
    $("#row_edit").dialog({
        ...
        buttons: {
            "Continue...": function() {
				window.location.href = "<?php echo base_url() ?>apreports/edit/" + ID;		
                $(this).dialog("close");
            },
            Cancel: function() {
                $(this).dialog("close");
...
function changeList(obj){
	...
	var urls = "<?php echo base_url();?>apreports/debitnoteList/"+df+"/"+dt;
...
<div class="head">
	<div class="info">
			...
			<ul class="breadcrumb">
                ...
                <li><a href="<?php echo base_url();?>ap/home"><?php echo $this->lang->line('module') ?></a> <span class="divider">-</span></li>
		...
		<div class="span12">
        	<div class="block">
            	...
            	<div class="head">
                	<h2><?php echo $this->lang->line('titlelist');?></h2>
                    	<ul class="buttons">
                    		<li><a href="<?php echo base_url(); ?>aptransaction/newDebitNote" title="Add New"><span class="i-plus-2"></span></a></li>
                        </ul>                                       
                </div>
            	...
            	<table cellpadding="0" cellspacing="0" width="100%" id="test" class="editable">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('posting');?></th>
			...
			<?php $bil = 0;
            	...
            	<tr>
                    ...
                    <td class="tac"><?php echo date('d-m-Y', strtotime($datatbl->debitNoteDate)); ?></td>
                    <td class="tac"><?php echo $datatbl->confirm?></td>
						<td class="tac"><?php
