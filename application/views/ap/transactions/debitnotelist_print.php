...
<title>Purchase Debit Note<?php echo $mode.'/'.$dateFrom.'/'.$dateTo ?></title>
...
function do_printexcel(){
	var url = "<?php echo base_url()?>aptransaction/dbnlist_excel/<?php echo $mode?>/<?php echo $dateFrom?>/<?php echo $dateTo?>";
...
<div>
	...
	<?php $bil = 0;
            	...
            	<tr>
                    ...
                    <td class="tac"><?php echo date('d-m-Y', strtotime($datatbl->date)); ?></td>
