...
function changeList(){
	...
	var urls = "<?php echo base_url();?>aptransaction/debitnotePost/"+df+"/"+dt;
...
//			alert(effdate);
 			$.ajax({
  				type: "POST",
	  			dataType: "json",
				url: "<?php echo base_url()?>Aptransaction/debitNotePosting",
				data: postData ,
	  			async: false,
		...
		<div class="row-fluid">
			...
			<?php $bil = 0; 
            	...
            	<tr>
                    ...
                    <td class="tac"><input type="checkbox" class="checkbox" id="checkbox"/> 
                    </td>
                </tr>
            <?php endforeach; }?>
                     </tbody>
            	...
            	<div class="side fr">
                	<div class="btn-group">
                        <?php 
							...
							$js='onclick="postdrtn()"';
							echo form_submit($data,$this->lang->line('postdbn'),$js);
							?>
                    </div>
                </div>
            </div>                                    
