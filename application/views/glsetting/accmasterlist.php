		...
		<div class="span12">
            	...
            	<div class="head">
                	<h2><?php echo $title ?></h2>
                    	<ul class="buttons">
                            ...
                            <li><a href="#" onClick='$("#test tbody").prepend("<tr><td>&nbsp</td><td id=type></td><td id=desc></td><td><button class=\"btn btn-mini btn-primary btn-block edit\">Edit</button></td></tr>").find("tr:first button.edit").trigger("click"); return false;'><span class="i-plus-2"></span></a></li>
                        </ul>                                        
                </div>
			...
			<?php $bil = 0; 
            	...
            	<tr>
                	...
                	<td id="fldac_code"><?php echo $datatbl->fldac_code; ?></td>
                	<td id="fldac_desc"><?php echo $datatbl->fldac_desc; ?></td>
                	<td id="fldac_type"><?php echo $datatbl->fldac_type; ?></td>
                	<td id="fldac_curr"><?php echo $datatbl->fldac_curr; ?></td>
                    <td class="tac"><?php
