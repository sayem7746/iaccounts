...
$(document).ready(function() {
    ...
    $("#test").dataTable( {
        "iDisplayLength": 5,
		 ...
		 "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null, { "bSortable": false } ]});
    ...
    $("#row_edit").dialog({
        ...
        buttons: {
            "Continue...": function() {
				window.location.href = "department?id=" + fldid;		
                $(this).dialog("close");
            },
            Cancel: function() {
                $(this).dialog("close");
		...
		<div class="span12">
			...
			<?php $bil = 0; 
            	...
            	<tr>
                	...
                	<td><?php echo $datatbl->dept_head; ?></td>
                    <td><?php 
