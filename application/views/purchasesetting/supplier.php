	...
	<div class="row-fluid">
		<div class="span12">
                	...
                	<div class="controls-row"><!-- Row 4-->
                    	<div class="span2"><?php echo form_label('Supplier Code:','fldsupp_code');?></div>
                   		<div class="span10">
								...
								echo form_input($data, set_value('fldsupp_code')); ?>
                  		</div>
                 	</div><!-- End Row 4-->
                	<div class="controls-row"><!-- Row 4-->
                    	<div class="span2"><?php echo form_label('Supplier Name:','fldsupp_name');?></div>
                   		<div class="span10">
								...
								echo form_input($data, set_value('fldsupp_name')); ?>
                  		</div>
                 	</div><!-- End Row 4-->
                 </div><!-- End Content-->
            </div> <!-- Block -->                                   
				...
				<div class="content np"> <!-- Content 1 -->   
                	<div class="controls-row"><!-- Row 4-->
                		...
                		<div class="span10">
								...
								echo form_input($data, set_value('fldsupp_contactperson')); ?>
                  		</div>
                	</div><!-- End Row 4-->
                	<div class="controls-row"><!-- Row 4-->
                		...
                		<div class="span3">
								...
								echo form_input($data, set_value('fldsupp_phone')); ?>
                		</div>
                		...
                		<div class="span3">
								...
								$data = array(
									...
									'id'=>'fldsupp_fax', 
									'class'=>'span9 validate[maxSize[25]]',); 
								echo form_input($data, set_value('fldsupp_fax')); ?>
                  		</div>
                	</div><!-- End Row 4-->
                	<div class="controls-row"><!-- Row 4-->
                		...
                		<div class="span10">
								...
								echo form_input($data, set_value('fldsupp_mobile')); ?>
                		</div>
                	</div><!-- End Row 4-->
                	<div class="controls-row"><!-- Row 4-->
                		...
                		<div class="span10">
								...
								$data = array(
									...
									'id'=>'fldsupp_addr', 
									'class'=>'span9 validate[maxSize[100]]',); 
								echo form_input($data, set_value('fldsupp_addr')); ?>
                		</div>
                	</div><!-- End Row 4-->
                	<div class="controls-row"><!-- Row 4-->
                	...
                	<div class="span10">
								...
								$data = array(
									...
									'id'=>'fldsupp_addr1', 
									'class'=>'span9 validate[maxSize[100]]',); 
								echo form_input($data, set_value('fldsupp_addr1')); ?>
                	</div>
                </div><!-- End Row 4-->
                <div class="controls-row"><!-- Row 4-->
                	...
                	<div class="span10">
								...
								$data = array(
									...
									'id'=>'fldsupp_addr2', 
									'class'=>'span9 validate[maxSize[100]]',); 
								echo form_input($data, set_value('fldsupp_addr2')); ?>
                	</div>
                </div><!-- End Row 4-->
                <div class="controls-row"><!-- Row 4-->
                   	<div class="span2"><?php echo form_label('Postcode:','postcode');?></div>
                	<div class="span4">
                            	<?php 								
								$data = array(
									'name'=>'postcode', 
                  	...
                  	<div class="span1" TAR><?php echo form_label('City:','city');?></div>
                	<div class="span5">
                            	<?php 								
								$data = array(
									'name'=>'city', 
                ...
                <div class="controls-row"> <!-- row 1 -->
                	...
                	<div class="span4">
						<?php
							...
							$js='onChange="changeList(this)" class="validate[required]"';
							echo form_dropdown('fldsupp_country', $options, $preselcountry, $js);
						?>       
                    </div>                
                	...
                	<div class="span4">
						<?php
							...
							$js='class="validate[required]" id="fldsupp_state"';
							echo form_dropdown('fldsupp_state', $options, $preselstate, $js);
						?>       
                	</div>                
                </div><!-- End Row 1 -->
               </div><!-- End Content-->
			...
			<div class="block">
				...
				<div class="content np"> <!-- Content 1 -->   
       			<div class="controls-row"> <!-- row 1 -->
            	<div class="span2"><?php echo form_label('Account Payable:','aset_acc');?></div>
            	<div class="span10">
						<?php
							$preselaccmaster = '';
							$options = '';
							$options[NULL] = '--Please Select Accont Number--';
							...
							$preselsubacc = '';
							$options = '';
							$options[NULL] = '--Please Select Sub Account--';
							foreach($subacc as $row){
								$options[$row->fldsubac_code] = '['.$row->fldsubac_code .'] '. $row->fldsubac_description;
							}
							echo form_dropdown('aset_sub_acc', $options, $preselsubacc);
						?>       
             	</div>
                  </div><!-- End Row 1 -->
                 </div><!-- End Content-->
