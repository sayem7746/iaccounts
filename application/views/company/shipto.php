...
$(document).ready(function(){
	...
	jQuery("#companyNo").keyup(function() {
	...
	<div class="row-fluid">
		<div class="span12">
			<?php 
				...
				$hidden['companyID'] = $companymaster->ID;
				if($shiptomaster)
				$hidden['ID'] = $shiptomaster->ID;
				$attrib = array('id'=>'validate'); 
				echo form_open('', $attrib, $hidden);?>
            	<div class="block">
                	<div class="head"><h2><?php echo $this->lang->line('title') ?></h2>
			...
			<div class="block">
                	<div class="head">
                    	<h2><?php echo $this->lang->line('titleNew') ?></h2>
				</div>
