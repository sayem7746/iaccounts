...
<title>Company Receive Payment List From <?php echo $dateFrom.' To '.$dateTo ?></title>
...
function do_printexcel(){
	var url = "<?php echo base_url()?>CompanySetup/compRecPaymentList_excel/<?php echo $mode?>/<?php echo $dateFrom?>/<?php echo $dateTo?>";
